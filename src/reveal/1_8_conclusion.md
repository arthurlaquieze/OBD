...
* Basically it generates a public URL with autogenerated ssh keys you connect to it using reverse proxy
...
* We basically use the codespace (connection via web) to bypass the network restriction, then connect to SSH
* This can be also useful when your data is never on your local machine
...
![remote](https://andrewwhitten.files.wordpress.com/2019/05/dx.png)

![This is the life at Tech Startups](https://www.uber.com/en-FR/blog/devpod-improving-developer-productivity-at-uber/)
